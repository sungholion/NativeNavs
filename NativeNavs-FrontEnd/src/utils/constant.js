export const categoryItem = [
  ...
  { name: "역사", state: false, idx: 4 },
  { name: "문화", state: false, idx: 5 },
  { name: "축제", state: false, idx: 6 },
  { name: "음식", state: false, idx: 7 },
  { name: "트렌디", state: false, idx: 8 },
  { name: "랜드마크", state: false, idx: 9 },
